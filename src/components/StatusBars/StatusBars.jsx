  ...
  return (
    <div className="flex justify-center items-center absolute top-[60px] left-0 w-full gap-5 m-5 px-5 z-[100]">
      ...
      <div className="flex items-center gap-2 min-w-[120px] bg-white/15 backdrop-blur-md rounded-[15px] p-2 hover:[&>.bar-fill]:brightness-110 hover:[&>.bar-icon]:scale-110 transition">
        <div className="text-[20px] w-6 text-center bar-icon" aria-label="hunger">🍽️</div>
      ...
      {/* Energy */}
      <div className="flex items-center gap-2 min-w-[120px] bg-white/15 backdrop-blur-md rounded-[15px] p-2 hover:[&>.bar-fill]:brightness-110 hover:[&>.bar-icon]:scale-110 transition">
        <div className="text-[20px] w-6 text-center bar-icon" aria-label="energy">⚡</div>
        <div className={barClass}>
          <div
      ...
      {/* Happiness */}
      <div className="flex items-center gap-2 min-w-[120px] bg-white/15 backdrop-blur-md rounded-[15px] p-2 hover:[&>.bar-fill]:brightness-110 hover:[&>.bar-icon]:scale-110 transition">
        <div className="text-[20px] w-6 text-center bar-icon" aria-label="happiness">😊</div>
        <div className={barClass}>
          <div
      ...
      {/* Hygiene */}
      <div className="flex items-center gap-2 min-w-[120px] bg-white/15 backdrop-blur-md rounded-[15px] p-2 hover:[&>.bar-fill]:brightness-110 hover:[&>.bar-icon]:scale-110 transition">
        <div className="text-[20px] w-6 text-center bar-icon" aria-label="hygiene">🧼</div>
        <div className={barClass}>
          <div
