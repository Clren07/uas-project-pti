...
useEffect(() => {
    console.log("BerenangActivity mounted, starting countdown:", durationInSeconds);
    ...
    return () => {
      ...
      console.log("BerenangActivity unmounted, interval cleared");
    };
  }, [durationInSeconds]);
  ...
  useEffect(() => {
    ...
    if (countdown === 0) {
      ...
      setPopupInfo({
        text: `Berenang selesai! +${happinessGain} Happiness, +${hygieneGain} Hygiene, -${energyLoss} Energy`,
  ...
  return (
    ...
    >
      <p style={{ fontSize: 26, marginBottom: 15 }}>Sedang berenang...</p>
...
export default BerenangActivity;
